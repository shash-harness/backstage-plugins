        ...
        return (
            <React.Fragment>
                <TableRow sx={{ '& > *': { borderBottom: 'unset' } }}>
                    ...
                    <TableCell align="left"><span onClick={() => setOpen(!open)}>{open ? <span>{React.createElement(UpIcon)}</span> : <span>{objectLength(row.sloHealthIndicators)}</span>}</span></TableCell>
    ...
    return (
        <TableContainer component={Paper} >
            <Table aria-label="collapsible table">
                <TableHead>
                    <TableRow>
                        <TableCell><h3>Monitored Service Name</h3></TableCell>
